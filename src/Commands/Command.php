...
use dmsysop\MikrotikApi\Contracts\CommandContract as CommandInterface;
use dmsysop\MikrotikApi\Core\Client;
use dmsysop\MikrotikApi\Core\QueryBuilder;
use dmsysop\MikrotikApi\Core\Request;
use dmsysop\MikrotikApi\Entity\Entity;
use dmsysop\MikrotikApi\Entity\GenericEntity;
use dmsysop\MikrotikApi\Exceptions\CommandException;
use dmsysop\MikrotikApi\Exceptions\InvalidCommandException;
use dmsysop\MikrotikApi\Support\EntityUtils;
...
abstract class Command implements CommandInterface
{
    ...
    /**
     *
     * @return \dmsysop\MikrotikApi\Core\Collection
     */
    public function get()
    {
